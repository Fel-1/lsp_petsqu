...
if(isset($_POST["checkout"])){
	...
	$q3 = mysqli_query($conn, "update cart set status='Confirmed' where orderid='$orderidd'");
	if($q3){
...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h1>Terima kasih, <?=$_SESSION['name']?> telah membeli <?php echo $itungtrans3 ?> makanan kucing di PetsQu Shop</span></h1>
			<br>
		...
		<br>
		<form method="post">
		<input type="submit" style ="margin-top: 80px" class="form-control btn btn-success" name="checkout" value="I Agree and Check Out" \>
		</form>
