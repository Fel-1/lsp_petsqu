<?php 
	...
	if(isset($_POST['deleteproduct'])){
		$id = $_POST['idproduk'];
		$q2 = mysqli_query($conn, "DELETE FROM produk where idproduk='$id'");
		if($q2){
                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$brgs=mysqli_query($conn,"SELECT * from produk p order by idproduk ASC");
											$no=1;
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
													...
													<td>
													<button style="margin-bottom:20px" data-toggle="modal" data-target="#editModal<?php echo $p['idproduk'] ?>" class="align-middle btn btn-success">Edit</button>
														...
														<div class="modal-dialog">
															<div class="modal-content">
																...
																<form action="produk.php" method="post" enctype="multipart/form-data" >
																	<input type="hidden", name="idproduk", type=text, value="<?= $p['idproduk'] ?>" >
																...
																<div class="modal-footer">
																	...
																	<input name="deleteproduct" type="submit" class="btn btn-danger" value="Delete">
					...
					<div class="modal-content">
						...
						<form action="produk.php" method="post" enctype="multipart/form-data" >
								<div class="form-group">
									...
									<input type="" name="idproduk" type="text" class="form-control" value='<?php echo $p['idproduk'] ?>' required>
								</div>
